...
function test_str() { 
    ...
    else {$("#divValidatepass").html("Password must have Uppercase letter,number,special character a minimum of 8 characters!").addClass('text-danger').removeClass('text-success');}
} 
function myFunction() {
